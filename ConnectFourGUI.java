...
public class ConnectFourGUI {
   ...
   private Color background = new Color(175, 175, 255);
   ...
   private final int FRAMEWIDTH = (int)(LOGOWIDTH * 1.02);
   ...
   private void initConfig() {
        ...
        //MAXGAME = Integer.parseInt(buf.readLine());
      logoIcon = "images/myLogo-1.jpg";
      iconFile = new String[NUMPLAYER];
      iconFile[0] = "images/player1-1.jpg";
      iconFile[1] = "images/player2-1.jpg";
   }
   ...
   private JPanel createInfoPanel() {
      ...
      Font headingFont = new Font ("ISOCPEUR", Font.PLAIN, 18);
      Font regularFont = new Font ("Proxy 9", Font.BOLD, 18);
   ...
   */
   ...
   /*
    * The anotherGame method displays a pop up window with the option to continute playing,
    * or the option of exiting the program.
    * Parameters: N/A
    * Returns: N/A
    */
   public void anotherGame() 
   {
     // Variable storing the choice of the user
      int anotherGame = JOptionPane.showConfirmDialog(null, "Another game?", "The match is finished", JOptionPane.YES_NO_OPTION, JOptionPane.PLAIN_MESSAGE);
     // Checks if the user clicked the "no" option 
      if(anotherGame == JOptionPane.NO_OPTION)     // if player does not want to play another game
      {
         System.exit(0);                           // exits the game
      }
     
     // Otherwise do nothing and continute runtime in the ConnectFour class
   }
